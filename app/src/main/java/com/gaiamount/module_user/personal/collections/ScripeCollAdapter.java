 ...
 */
public class ScripeCollAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ArrayList <ScripeInfo> scripeInfos;
    private long uid;

    public ScripeCollAdapter(Context context, ArrayList<ScripeInfo> scripeInfos) {
    ...
    private void collectNet(final long sid, final int position) {
        ...
        ScriptApiHelper.getScriptCollect(sid, uid, 0, context, handler);
    }
}
