...
public class NoteCommentAdapter extends BaseAdapter {
    private List<PlayerCommentInfo> commentInfo;
    private Context context;

    public NoteCommentAdapter(Context context, List<PlayerCommentInfo> commentInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PlayerCommentInfo info = commentInfo.get(position);
        if(convertView==null){
        ...
        long time = info.getCreateTime().getTime();
        viewHolder.textViewTime.setText(getTime(time));
