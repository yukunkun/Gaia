 ...
 */
public class CreateCollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CreateCollectionAdapter(Context context, ArrayList<MixInfo> mixInfos,long uid){
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MixViewHolder)holder).imageViewMore.setOnClickListener(new View.OnClickListener() {
            ...
            private void showPopu(ImageView view,long id,int position) {
                ...
                //在控件上方显示
                popupWindow.showAsDropDown(view,0-popupWidth+ScreenUtils.dp2Px(context, 20),0-popupHeight- ScreenUtils.dp2Px(context, 25));
            }
        });
    }
    ...
    class Listener implements View.OnClickListener {
        ...
        public Listener(long id, int position) {
            this.id=id;
        ...
        @Override
        public void onClick(View v) {
            EventBus.getDefault().post(new OnEventAcademy(position));
            popupWindow.dismiss();
        }
    }
