 ...
 */
public class AcademyDialog extends DialogFragment{
    ...
    public static AcademyDialog newInstance(long wid, int position, int type) {
        AcademyDialog fragment = new AcademyDialog();
    ...
    private void getInfo() {
        MJsonHttpResponseHandler handler = new MJsonHttpResponseHandler(AcademyDialog.class) {
            @Override
    ...
    private void addGroup(long aid) {
        ...
        AlbumApiHelper.addWorksToAlbum(wids,6,albumId,getActivity(),handler);

//        AlbumApiHelper.addVideoToAlbum(wids,6,aid,getActivity(),handler);
    }
}
