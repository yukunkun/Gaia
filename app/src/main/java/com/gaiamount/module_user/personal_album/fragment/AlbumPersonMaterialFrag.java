...
import com.gaiamount.module_user.personal_album.adapter.MaterialPersonAlbumAdapter;
 ...
 */
public class AlbumPersonMaterialFrag extends Fragment {
    ...
    private MaterialPersonAlbumAdapter adapter;


    public static AlbumPersonMaterialFrag newInstance(long aid, int t, Info info) {

        Bundle args = new Bundle();
        args.putLong(AID, aid);
        args.putInt(ALBUM_TYPE,t);
        args.putSerializable("info",info);
        AlbumPersonMaterialFrag fragment = new AlbumPersonMaterialFrag();
    ...
    private void getInfo() {
        MJsonHttpResponseHandler handler=new MJsonHttpResponseHandler(AlbumPersonMaterialFrag.class){
            @Override
    ...
    private void setadapter() {
        adapter = new MaterialPersonAlbumAdapter(getContext(), mLessonInfoList,info);
