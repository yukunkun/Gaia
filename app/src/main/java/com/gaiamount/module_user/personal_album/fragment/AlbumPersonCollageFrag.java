...
import com.gaiamount.module_user.personal_album.adapter.AlbumPersonCollectionAdapter;
 ...
 */
public class AlbumPersonCollageFrag extends Fragment {
    ...
    private AlbumPersonCollectionAdapter adapter;
    private Info info;

    public static AlbumPersonCollageFrag newInstance(long aid, int t, Info info, int c) {
        ...
        AlbumPersonCollageFrag fragment = new AlbumPersonCollageFrag();
    ...
    private void getInfo() {
        MJsonHttpResponseHandler handler=new MJsonHttpResponseHandler(AlbumPersonCollageFrag.class){
            @Override
    ...
    private void setadapter() {
        adapter = new AlbumPersonCollectionAdapter(getContext(), mLessonInfoList,info);
