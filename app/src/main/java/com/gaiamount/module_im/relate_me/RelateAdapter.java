...
public class RelateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RelateAdapter(Context context, ArrayList<AttentInfo> attentInfos) {
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyViewHolder){
            ...
            ((MyViewHolder) holder).layout.setVisibility(View.VISIBLE); //消失的view
            ...
            if(attentInfo.getCover()!=null&&attentInfo.getCover()!=""){
                Glide.with(context).load(Configs.COVER_PREFIX+attentInfos.get(position).getCover()).into(((MyViewHolder) holder).imageViewCover);
            ...
            if(types==2){
                if(contentType==0){
                    ((MyViewHolder) holder).textViewAction.setText("添加我的作品"+attentInfo.getContentName()+"到小组"+attentInfo.getGroupName());
                }if(contentType==1){
                    ((MyViewHolder) holder).textViewAction.setText("添加我的素材"+attentInfo.getContentName()+"到小组"+attentInfo.getGroupName());
                }if(contentType==2){
                    ((MyViewHolder) holder).textViewAction.setText("添加我的剧本"+attentInfo.getContentName()+"到小组"+attentInfo.getGroupName());
                }
                if(contentType==3){
                    ((MyViewHolder) holder).textViewAction.setText("添加我的教程"+attentInfo.getContentName()+"到小组"+attentInfo.getGroupName());
                }
            ...
            if(contentType==1&&(types==0||types==1||types==6)){
                if(types==0){
                    ((MyViewHolder) holder).textViewAction.setText("购买了我的素材");
                }if(types==1){
                    ((MyViewHolder) holder).textViewAction.setText("收藏了我的素材");
                }
                ((MyViewHolder) holder).textViewContent.setText(attentInfo.getContentName());
                ((MyViewHolder) holder).textViewSign.setText(attentInfo.getDescription());
            }
            ...
            if(contentType==2&&(types==0||types==1||types==6)){
                if(types==0){
                    ((MyViewHolder) holder).textViewAction.setText("购买了我的剧本");
                }if(types==1){
                    ((MyViewHolder) holder).textViewAction.setText("收藏了我的剧本");
                }
                ((MyViewHolder) holder).textViewContent.setText(attentInfo.getContentName());
                ((MyViewHolder) holder).textViewSign.setText(attentInfo.getDescription());
            }
            ...
            if(contentType==3&&(types==0||types==1||types==6)){
                if(types==0){
                    ((MyViewHolder) holder).textViewAction.setText("购买了我的教程");
                }if(types==1){
                    ((MyViewHolder) holder).textViewAction.setText("收藏了我的教程");
                }
                ((MyViewHolder) holder).textViewContent.setText(attentInfo.getContentName());
                ((MyViewHolder) holder).textViewSign.setText(attentInfo.getDescription());
            }
            ...
            if(contentType==4&&(types==0||types==5)){
               if(contentType==5){
                    ((MyViewHolder) holder).textViewAction.setText("转载我的手记");
                }
                ((MyViewHolder) holder).textViewContent.setText(attentInfo.getContentName());
                ((MyViewHolder) holder).textViewSign.setText(attentInfo.getDescription());
            }
