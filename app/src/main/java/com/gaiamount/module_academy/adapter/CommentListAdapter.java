...
public class CommentListAdapter extends BaseAdapter {
    ...
    public CommentListAdapter(Context context,ArrayList<CommentInfo> commentInfo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(info.getGrade()==0){
            viewHolder.textViewGrade.setText(0.0+"");
        }else {
            viewHolder.textViewGrade.setText(df.format(info.getGrade())+"");
        }
        viewHolder.ratingBar.setProgress((int)info.getGrade());
