...
public class RecyclerViewHeader2 extends RelativeLayout {
    ...
    /**
     * Inflates layout from <code>xml</code> and encapsulates it with <code>RecyclerViewHeader2</code>.
     *
     * @param context   application context.
     * @param layoutRes layout resource to be inflated.
     * @return <code>RecyclerViewHeader2</code> view object.
     */
    public static RecyclerViewHeader2 fromXml(Context context, @LayoutRes int layoutRes) {
        RecyclerViewHeader2 header = new RecyclerViewHeader2(context);
    ...
    /**
     * Attaches <code>RecyclerViewHeader2</code> to <code>RecyclerView</code>.
     ...
     *
     * @param recycler <code>RecyclerView</code> to attach <code>RecyclerViewHeader2</code> to.
     */
     ...
     *                             that user has already aligned <code>RecyclerViewHeader2</code> properly.
     */
    ...
    private void setupAlignment(RecyclerView recycler) {
        if (!mAlreadyAligned) {
            ...
            RecyclerViewHeader2.this.setLayoutParams(newHeaderParams);
            ...
            if (currentParent instanceof ViewGroup) {
                ...
                newRootParent.addView(RecyclerViewHeader2.this);
    ...
    private void setupHeader(final RecyclerView recycler) {
        recycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                mCurrentScroll += dy;
                RecyclerViewHeader2.this.setTranslationY(-mCurrentScroll);
            }
        });

        RecyclerViewHeader2.this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                int height = RecyclerViewHeader2.this.getHeight();
                if (height > 0) {
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
                        RecyclerViewHeader2.this.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    } else {
                        RecyclerViewHeader2.this.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                    }
    ...
    private void validateRecycler(RecyclerView recycler, boolean headerAlreadyAligned) {
        ...
        if (layoutManager == null) {
            throw new IllegalStateException("Be sure to call RecyclerViewHeader2 constructor after setting your RecyclerView's LayoutManager.");
            ...
            throw new IllegalArgumentException("Currently RecyclerViewHeader2 supports only LinearLayoutManager, GridLayoutManager and StaggeredGridLayoutManager.");
        }

        if (layoutManager instanceof LinearLayoutManager) {
            if (((LinearLayoutManager) layoutManager).getOrientation() != LinearLayoutManager.VERTICAL) {
                throw new IllegalArgumentException("Currently RecyclerViewHeader2 supports only VERTICAL orientation LayoutManagers.");
            }
        } else if (layoutManager instanceof StaggeredGridLayoutManager) {
            if (((StaggeredGridLayoutManager) layoutManager).getOrientation() != StaggeredGridLayoutManager.VERTICAL) {
                throw new IllegalArgumentException("Currently RecyclerViewHeader2 supports only VERTICAL orientation StaggeredGridLayoutManagers.");
            }
        }
        ...
        if (!headerAlreadyAligned) {
            ...
            if (parent != null &&
                ...
                throw new IllegalStateException("Currently, NOT already aligned RecyclerViewHeader2 " +
