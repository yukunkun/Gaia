 ...
 */
public class SurfaceRenderView extends SurfaceView implements IGaiaRenderView {
    ...
    private static final class InternalSurfaceHolder implements IGaiaRenderView.ISurfaceHolder {
        ...
        @NonNull
        @Override
        public IGaiaRenderView getRenderView() {
            return mSurfaceView;
        }
