...
public class CommentListAdapter extends BaseAdapter {
    ...
    public CommentListAdapter(AppCompatActivity context, CommentFragment commentFragment,
    ...
    class ViewHolder {
        ...
        public void setValue(final int position) {
            ...
            Glide.with(mContext).load(Configs.COVER_PREFIX+avatar).placeholder(R.mipmap.ic_avatar_default).into(this.avatar);
//            mImageUtils.getAvatar(this.avatar, avatar);
            ...
            if (originContent != null && !originContent.equals("null") && !TextUtils.isEmpty(originContent)) {
                ...
                Glide.with(mContext).load(Configs.COVER_PREFIX+originAvatar).placeholder(R.mipmap.ic_avatar_default).into(callBackAvatar);
            ...
            commentIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //打开回复
                    commentFragment.replyToggle(true, position);
                }
            });
                ...
                public void onClick(View v) {
                    DialogInterface.OnClickListener onPositiveClickListener = new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            MJsonHttpResponseHandler handler = new MJsonHttpResponseHandler(CommentListAdapter.class, progressDialog) {
                                @Override
