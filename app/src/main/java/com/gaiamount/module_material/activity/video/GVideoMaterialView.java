...
import com.gaiamount.widgets.media.IGaiaRenderView;
import com.gaiamount.widgets.media.SurfaceRenderView;
 ...
 * 应用播放的视图控件
 */
public class GVideoMaterialView extends FrameLayout implements GMaterialController.GMaterialPlayerControl{
    ...
    public GVideoMaterialView(Context context) {
        super(context);
        initVideoView(context);
    }

    public GVideoMaterialView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVideoView(context);
    }

    public GVideoMaterialView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initVideoView(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public GVideoMaterialView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//            IGaiaRenderView.AR_ASPECT_FILL_PARENT,
//            IGaiaRenderView.AR_ASPECT_WRAP_CONTENT,
//            IGaiaRenderView.AR_MATCH_PARENT,// 打开
    ...
    public void changeRenderSize(int index) {
         ...
         */
        View renderUIView = mRenderView.getView();
        LayoutParams lp = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT,Gravity.CENTER);
        renderUIView.setLayoutParams(lp);
        addView(renderUIView);
        mRenderView.addRenderCallback(mSHCallback);
        mRenderView.setVideoRotation(mVideoRotationDegree);
    ...
    public void setMediaController(IGMediaController controller) {
        ...
        mMediaController = (GMaterialController) controller;
 ...
 */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        LogUtil.d(GVideoMaterialView.class, "width:" + width + ";height:" + height);
        //随着手指滑动，屏幕亮度随之改变
