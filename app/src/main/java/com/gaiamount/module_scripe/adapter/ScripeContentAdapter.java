 ...
 */
public class ScripeContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    private MyViewHolder holder;
    private ArrayList<String> stringsList;

    public ScripeContentAdapter(ArrayList<String> stringsList, Context context) {
