 ...
 */
public class OutAccountBookRecycerAdapter extends RecyclerView.Adapter<OutAccountBookRecycerAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(OutAccountBookRecycerAdapter.ViewHolder holder, int position) {
        OutProfit.ABean a = mList.get(position);
        holder.mName.setText(a.getContentName());
        ...
        holder.mBank.setText("支付方式："+a.getChannel());
