 ...
 */
public class AlbumScriptFrag extends Fragment {
    private int mC;
    ...
    private AlbumScripeAdapter adapter;

    public static AlbumScriptFrag newInstance(long aid, int t, Info info) {

        Bundle args = new Bundle();
        args.putLong(AID, aid);
        args.putInt(ALBUM_TYPE,t);
        args.putSerializable("info",info);
        AlbumScriptFrag fragment = new AlbumScriptFrag();
    ...
    private void setadapter() {
        adapter = new AlbumScripeAdapter(getContext(),mLessonInfoList,info);
