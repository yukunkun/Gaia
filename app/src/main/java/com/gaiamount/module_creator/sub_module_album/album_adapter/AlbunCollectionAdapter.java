...
public class AlbunCollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AlbunCollectionAdapter(Context context, ArrayList<MixInfo> mixInfos, Info info){
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if(info.groupPower.allowCleanCreation==1){ // 判断是否有删除的权限
...
//                        (location[0] + view.getWidth() / 2) - popupWidth*2, location[1] - popupHeight*2);
                popupWindow.showAsDropDown(view,0-popupWidth-ScreenUtils.dp2Px(context, 20),0-popupHeight-ScreenUtils.dp2Px(context, 50));
            }
        });
    ...
    private void removeVideo(final MixInfo mixInfo, final int evenPos, Context context) {
        ...
        AlbumApiHelper.removeVideoFromAlbum(id, info.gid,3,context, handler);
    }
