...
//    interfaces.SetOnItemClickListener onItemClickListener;
    ...
    public FansAdapter(Context context, List attentionList){
        this.context=context;
        this.attentionList=attentionList;
    }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.fanslayout, null);
    ...
    class AttViewHolder extends RecyclerView.ViewHolder{
        ...
        public AttViewHolder(View itemView, final Context context, final int viewType) {
            super(itemView);
            circleImageViewHead= (CircleImageView) itemView.findViewById(R.id.fans_head);
            linearLayoutSiXin= (LinearLayout) itemView.findViewById(R.id.sixin);
            linearLayoutAttent= (LinearLayout) itemView.findViewById(R.id.fans);
            textViewName= (TextView) itemView.findViewById(R.id.fans_name);
            textViewMess= (TextView) itemView.findViewById(R.id.fans_mes);
            ...
            linearLayoutAttent.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    PersonApiHelper.addAttention(attentionList.get(viewType).getId(),1,context);
