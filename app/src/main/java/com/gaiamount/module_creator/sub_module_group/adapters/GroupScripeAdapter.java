...
public class GroupScripeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupScripeAdapter(Context context, ArrayList<ScripeInfo> scripeInfos,Info info) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof MyViewHolder){
            ...
            ((MyViewHolder) holder).imageViewMore.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showPopu(((MyViewHolder) holder).imageViewMore, scripeInfos.get(position).getGvid(), position);
                }
            });
        }
    }
