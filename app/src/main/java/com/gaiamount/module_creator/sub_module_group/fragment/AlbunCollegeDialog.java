...
public class AlbunCollegeDialog extends DialogFragment{
    ...
    public static AlbunCollegeDialog newInstance(long gid, MixInfo mList, int position) {
        AlbunCollegeDialog fragment = new AlbunCollegeDialog();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList= (MixInfo) arguments.getSerializable("mList");
    }
    ...
    private void getInfo() {
        MJsonHttpResponseHandler handler = new MJsonHttpResponseHandler(AlbunCollegeDialog.class) {
            @Override
    ...
    private void addGroup(long aid) {
        ...
        AlbumApiHelper.addVideoToAlbum(wids,3,aid,getActivity(),handler);//type 3才是学院
    }
}
