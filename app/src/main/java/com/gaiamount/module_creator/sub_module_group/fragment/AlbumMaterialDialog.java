 ...
 */
public class AlbumMaterialDialog extends DialogFragment{
    ...
    private MaterialInfo mList;

    public static AlbumMaterialDialog newInstance(long gid, MaterialInfo mList, int position) {
        AlbumMaterialDialog fragment = new AlbumMaterialDialog();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList= (MaterialInfo) arguments.getSerializable("mList");
    }
    ...
    private void getInfo() {
        MJsonHttpResponseHandler handler = new MJsonHttpResponseHandler(AlbumMaterialDialog.class) {
            @Override
    ...
    private void addGroup(long aid) {
        ...
        Long[] wids = new Long[]{Long.valueOf(mList.getId())};
        MJsonHttpResponseHandler handler = new MJsonHttpResponseHandler(AlbumMaterialDialog.class){
            @Override
            public void onGoodResponse(JSONObject response) {
                super.onGoodResponse(response);
        ...
        AlbumApiHelper.addVideoToAlbum(wids,1,aid,getActivity(),handler);//type 1才是素材
    }
}
